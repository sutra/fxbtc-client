...
import com.redv.fxbtc.valuereader.JsonValueTypeRefReader;
import com.redv.fxbtc.valuereader.ValueReader;
...
public class HttpClient implements AutoCloseable {
	...
	public <T> T post(URI uri, Class<T> valueType, NameValuePair... params)
			throws IOException {
		return post(uri, new JsonValueReader<T>(objectMapper, valueType), params);
	}

	public <T> T post(URI uri, Class<T> valueType, String content,
